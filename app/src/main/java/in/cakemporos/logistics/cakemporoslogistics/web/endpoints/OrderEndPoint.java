...
public interface OrderEndPoint {
    ...
    @PUT("user/rider/order/{orderid}/start")
    public Call<Response> startOrder(@Header("x-access-token") String accessToken,@Path("orderid") String id);

    @PUT("user/rider/order/location")
    public Call<LocationResponse> sendLocation(@Header("x-access-token") String accessToken, @Body Location location);
